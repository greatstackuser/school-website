    ...
    <div className='about' id='about'>
      ...
      <div className="about-right">
        ...
        <div className="about-btn">
          <p><HashLink to='/about/school' className='btn dark-btn'>Our School</HashLink></p>
          <p><HashLink to='/about/team' className='btn dark-btn'>Our Team</HashLink></p>
          <p><HashLink to='/about/philosophy' className='btn dark-btn'>Our Philosophy</HashLink></p>
          <p><HashLink to='/about/curriculum' className='btn dark-btn'>Our Curriculum</HashLink></p>
        </div>
      </div>
    </div>
  )
